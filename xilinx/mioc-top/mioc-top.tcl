...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "/tools/projects/mioc-top/mioc_top.ucf" -process "Lock Pins"
   ...
   project set "Work Directory" "/tools/projects/mioc-top/xst" -process "Synthesize - XST"
