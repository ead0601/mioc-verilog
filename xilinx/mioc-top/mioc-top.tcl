...
proc set_process_props {} {
   ...
   project set "User Browsed Strategy Files" "/build/tools/Xilinx/14.7/ISE_DS/ISE/data/default.xds"
   ...
   project set "Target UCF File Name" "/build/repo/mioc-verilog/xilinx/mioc-top/mioc_top.ucf" -process "Lock Pins"
   ...
   project set "Work Directory" "/build/repo/mioc-verilog/xilinx/mioc-top/xst" -process "Synthesize - XST"
