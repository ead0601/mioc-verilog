# 
# Project automation script for mioc-top 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source mioc-top.tcl), then you can
...
set myProject "mioc-top"
set myScript "mioc-top.tcl"
...
proc add_source_files {} {
   ...
   xfile add "mioc_top.ucf"
   xfile add "src/mioc_flop_rtl.v"
   xfile add "src/mioc_inv1_rtl.v"
   xfile add "src/mioc_nand2_rtl.v"
   xfile add "src/mioc_nand4_nor2_rtl.v"
   xfile add "src/mioc_nor2_rtl.v"
   xfile add "src/mioc_nor3_rtl.v"
   xfile add "src/mioc_top.v"
   xfile add "src/mioc_xnor2_rtl.v"

   # Set the Top Module as well...
   project set top "mioc_top"
...
proc set_process_props {} {
   ...
   project set "User Browsed Strategy Files" "/local/ws/ediaz/Xilinx/14.7/ISE_DS/ISE/data/default.xds"
   ...
   project set "Target UCF File Name" "/local/ws/ediaz/PROJECTS/XILINX/MIOC/mioc-top/mioc_top.ucf" -process "Lock Pins"
   ...
   project set "Work Directory" "/local/ws/ediaz/PROJECTS/XILINX/MIOC/mioc-top/xst" -process "Synthesize - XST"
   project set "Other XST Command Line Options" "" -process "Synthesize - XST"
   project set "Auto Implementation Compile Order" "false"
   ...
   project set "Output File Name" "mioc_top" -process "Generate IBIS Model"
